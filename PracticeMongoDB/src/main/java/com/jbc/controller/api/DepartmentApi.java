...
/*Swagger documentation for Department*/
public interface DepartmentApi {
	...
	public ResponseEntity<?> deleteDepartment(
			@ApiParam(required = true, value = "ID of the Department to delete", example = "0") @RequestParam long departmentId);
	...
	public ResponseEntity<?> AddEmployee(
			@ApiParam(required = true, value = "ID of the Department to add the Employee to", example = "0") @RequestParam long departmentId,
			@ApiParam(required = true, value = "ID of the Employee to add", example = "0") @RequestParam long employeeId);
	...
	public ResponseEntity<?> getDepartment(
			@ApiParam(required = true, value = "ID of the Department to return", example = "0") @RequestParam long departmentId);
	...
	public ResponseEntity<?> getDepartment(
			@ApiParam(required = true, value = "Name of the Department to return") @RequestParam String name);
